...
#The function uses the d3m library to perform various data quality checks on the provided dataset. These checks include:
...
#The function uses the d3m library to perform various data drift checks between the reference and current datasets. These checks include:
...
#The function returns a dictionary containing two items:
#"report": The data drift report generated by the d3m library.
...
#The function uses the d3m library to perform various model drift checks between the reference and current datasets. These checks include:
